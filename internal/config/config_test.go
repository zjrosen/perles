...
func TestValidateOrchestration_ValidOpenCodeModels(t *testing.T) {
	models := []string{"anthropic/claude-opus-5-5", "anthropic/claude-sonnet-4", "openai/gpt-4o"}
	for _, model := range models {
		cfg := OrchestrationConfig{
			Client:   "opencode",
...
func TestDefaults_Orchestration(t *testing.T) {
	...
	require.Equal(t, "claude-opus-5-5", cfg.Orchestration.Claude.Model)
...
func TestExtensionsForClient_Codex_WithModel(t *testing.T) {
	cfg := OrchestrationConfig{
		Codex: CodexClientConfig{Model: "gpt-6-sol"},
	}
	ext := cfg.extensionsForClient("codex", false)
	require.Equal(t, "gpt-6-sol", ext["codex.model"])
}
...
func TestExtensionsForClient_Gemini_WorkerSameAsCoordinator(t *testing.T) {
	cfg := OrchestrationConfig{
		Gemini: GeminiClientConfig{Model: "gemini-3.8-flash"},
	}
...
func TestExtensionsForClient_OpenCode_WorkerSameAsCoordinator(t *testing.T) {
	cfg := OrchestrationConfig{
		OpenCode: OpenCodeClientConfig{Model: "anthropic/claude-opus-5-5"},
	}
...
func TestExtensionsForObserver_Codex(t *testing.T) {
	...
	require.Equal(t, "gpt-6-sol", ext[client.ExtCodexModel])
}
...
func TestExtensionsForObserver_Gemini(t *testing.T) {
	...
	require.Equal(t, "gemini-3.8-flash", ext[client.ExtGeminiModel])
}
...
func TestExtensionsForObserver_OpenCode(t *testing.T) {
	...
	require.Equal(t, "anthropic/claude-opus-5-5", ext[client.ExtOpenCodeModel])
}
