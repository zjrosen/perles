...
2. **Create the plan document** at `{{.Config.document_path}}/{{ .Date }}--{{ .Name }}/plan.md` with the structure below
...
- [ ] Created plan document at `{{.Config.document_path}}/{{ .Date }}--{{ .Name }}/plan.md`
