...
// This is calculated as InputTokens + CacheReadInputTokens + CacheCreationInputTokens,
// representing all tokens the model sees in its context window for this turn.
// Returns 0 if no usage info is available.
func (e *OutputEvent) GetContextTokens() int {
	if e.Usage == nil {
		return 0
	}
	return e.Usage.InputTokens + e.Usage.CacheReadInputTokens + e.Usage.CacheCreationInputTokens
}
...
// UsageInfo holds detailed token usage from result events.
